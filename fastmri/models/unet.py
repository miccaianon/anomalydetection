""" Parts of the U-Net model https://github.com/milesial/Pytorch-UNet/blob/master/unet/unet_model.py """
...
class Unet(nn.Module):
    def __init__(self, n_channels, n_classes, chans, bilinear=True):
        super(Unet, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
        self.chans = chans
        self.inc = DoubleConv(n_channels, chans)
